...
#
# COmain_year <- full_sa_di[[myear]]
# main_year_list <- split(COmain_year, main_year$contested)
...
#
# contested_main_year <- COmain_year %>%
...
#        l1 <- COprecincts_not_found(temp=temp32, COmain_year, statewide_main_year, statewide_main_minus_two,
#                                    statewide_main_minus_four, dis_name, dis_est),
#        l1 <- precincts_found(COmain_year, mainyearminus2, mainyearminus4, dis_name, districts))
# districts_full[i, ] <- as.data.frame(l1)
# #}
#
# COprecincts_not_found(temp=temp32, main_year=COmain_year, statewide_main_year, statewide_main_minus_two,
#                       statewide_main_minus_four, dis_name, dis_est)
#
#
#
