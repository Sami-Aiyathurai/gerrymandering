...
efficiency_gap_contested(votes_2010, 2010)

efficiency_gap(votes_2014, 2014)
efficiency_gap_contested(votes_2014, 2014)

efficiency_gap(votes_2016, 2016)
efficiency_gap_contested(votes_2016, 2016)

efficiency_gap(votes_2018, 2018)
efficiency_gap_contested(votes_2018, 2018)
